...
public class ResizeableOrthographicCamera extends OrthographicCamera {
	...
	public ResizeableOrthographicCamera(int width, int height) {
		this(new VirtualViewport(width, height));
	}
	
	public ResizeableOrthographicCamera(VirtualViewport virtualViewport) {
		this(virtualViewport, 0f, 0f);
	}

	public ResizeableOrthographicCamera(VirtualViewport virtualViewport, float cx, float cy) {
